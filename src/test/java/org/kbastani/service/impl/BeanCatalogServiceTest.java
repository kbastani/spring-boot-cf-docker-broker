package org.kbastani.service.impl;
...
public class BeanCatalogServiceTest {
	...
	public void catalogIsReturnedSuccessfully() {
		Assert.assertEquals(catalog, service.getCatalog());
	}
	
	@Test 
	public void itFindsServiceDefinition() {
		Assert.assertEquals(serviceDefinition, service.getServiceDefinition(SVC_DEF_ID));
	}
